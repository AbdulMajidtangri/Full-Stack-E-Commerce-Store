...
export default function NewlyLaunchedProducts() {
  ...
  // Load newly launched products
  useEffect(() => {
    const products = getNewlyLaunchedProducts();
 ...
 const handleAddToCart = async (product) => {
  ...
  if (!newlyLaunched || newlyLaunched.length === 0)
    return <div className="text-center text-gray-400 py-20">No newly launched products available.</div>;
